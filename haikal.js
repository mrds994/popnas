...
//=================================================//
case 'pdana': {
haikal.sendMessage(from, { image: dana,  caption: `DANA : 087860442722` }, { quoted:m })
}
break
case 'pgopay': {
haikal.sendMessage(from, { image: gopay,  caption: `GOPAY : 087860442722` }, { quoted:m })
}
break
case 'pbca': {
...
case 'redemcode': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `*CARA MASUKAN KODE REDDEM *
` , mentions: participants.map(a => a.id)}, { quoted:m })
}
break
...
haikal.sendListMsg(from, `Settings Online Admin Panel Amgeekz`, haikal.user.name, `Hello Owner !`, `Click Here`, sections, m)
 ...
 let setbot = global.db.data.settings[botNumber]
if (setbot.inod) {
haikal.sendMessage(from, { image: ppnyauser, caption: `*List Admin * :
